...
public class Followers_Following_ViewPager extends FragmentPagerAdapter {


    public Followers_Following_ViewPager(@NonNull FragmentManager fm) {
        super(fm);
    }

    public Followers_Following_ViewPager(@NonNull FragmentManager fm, int behavior) {
        super(fm, behavior);
    }
