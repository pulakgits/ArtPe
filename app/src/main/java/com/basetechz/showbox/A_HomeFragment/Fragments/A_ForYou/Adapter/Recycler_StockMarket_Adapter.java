...
public class Recycler_StockMarket_Adapter extends RecyclerView.Adapter<Recycler_StockMarket_Adapter.ViewHolder> {
    Context context;
    ArrayList<movie_data_model> arrayList = new ArrayList<>();
    public Recycler_StockMarket_Adapter(Context context,ArrayList<movie_data_model> arrayList){
