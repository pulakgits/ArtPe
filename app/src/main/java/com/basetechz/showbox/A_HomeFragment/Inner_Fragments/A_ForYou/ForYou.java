package com.basetechz.showbox.A_HomeFragment.Inner_Fragments.A_ForYou;
...
import com.basetechz.showbox.models.slideImgModel;
        ...
        databaseReference.child("SlideMovie").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    slideImgModel slideImgModel = dataSnapshot.getValue(com.basetechz.showbox.models.slideImgModel.class);
